...
export const banks: BankOption[] = [
  ...
  // India Banks
  { name: 'State Bank of India', logo: 'https://www.google.com/s2/favicons?domain=sbi.co.in&sz=128', country: 'IN' },
  { name: 'HDFC Bank', logo: 'https://www.google.com/s2/favicons?domain=hdfcbank.com&sz=128', country: 'IN' },
  { name: 'ICICI Bank', logo: 'https://www.google.com/s2/favicons?domain=icicibank.com&sz=128', country: 'IN' },
  ...
  { name: 'IndusInd Bank', logo: 'https://www.google.com/s2/favicons?domain=indusind.com&sz=128', country: 'IN' },
  { name: 'Yes Bank', logo: 'https://www.google.com/s2/favicons?domain=yesbank.in&sz=128', country: 'IN' },
  { name: 'IDFC First Bank', logo: 'https://www.google.com/s2/favicons?domain=idfcfirstbank.com&sz=128', country: 'IN' },
