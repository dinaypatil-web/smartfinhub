...
When creating/editing a loan payment transaction, shows breakdown for **current payment only**:

```
┌──────────────────────────────────────────────┐
│  EMI Breakdown              [Manual Adjust]   │
├──────────────────────────────────────────────┤
│  (For THIS Payment Only - No Past Data)      │
│                                              │
│  ┌──────────┬──────────┬────────────────┐   │
...
│                                              │
│  💡 Shows breakdown for current payment     │
│  only. Does not include past EMI data.      │
│  Saved to EMI Payment History.              │
└──────────────────────────────────────────────┘
```
