...
- Manual bank name entry option if institution not listed\n- **Automatic Logo Fetching**: When bank/loan/credit card account logo is not available in the system database, automatically fetch the logo from internet sources\n- Fetched logos displayed on both account pages and dashboard
