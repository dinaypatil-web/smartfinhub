...
- Calculate and display total accrued interest till date on dashboard and account page

**Loan Account Details:**
- Input total principal loan amount
- Auto-calculate loan EMI based on principal, initial interest rate, and tenure\n- Display total accrued interest till date on dashboard and account page
...
- Total accrued interest till date displayed for each loan account
...
- Total accrued interest till date for loan accounts
